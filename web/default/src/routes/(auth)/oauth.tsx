...
import { buildSignInPath, sanitizeRedirect } from '@/features/auth/lib/redirect'
    ...
    ;(async () => {
      try {
        ...
        if (res?.success) {
          ...
          const target = sanitizeRedirect(search?.redirect) || '/dashboard'
      ...
      navigate({
        to: buildSignInPath(search?.redirect),
        replace: true,
      })
    })()
  }, [navigate, search])
