    ...
    build: (settings: AuthSettings) => (
      <BasicAuthSection
        defaultValues={{
          ...
          SMSTemplateParam: settings.SMSTemplateParam,
          SMSSchemeName: settings.SMSSchemeName,
          SMSCodeLength: settings.SMSCodeLength,
          SMSValidTime: settings.SMSValidTime,
          SMSInterval: settings.SMSInterval,
