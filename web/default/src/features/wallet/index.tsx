...
import { getReferralOverview } from '@/features/referrals/api'
...
export function Wallet(props: WalletProps) {
  ...
  const referralOverviewQuery = useQuery({
    queryKey: ['referrals', 'wallet-summary'],
    queryFn: async () => {
      const response = await getReferralOverview(1, 1)
        ...
        <SectionPageLayout.Content>
          <div className='mx-auto flex w-full max-w-7xl flex-col gap-4 sm:gap-5'>
            ...
            <AffiliateRewardsCard
              user={user}
              overview={referralOverviewQuery.data}
              loading={userLoading || referralOverviewQuery.isLoading}
            />
