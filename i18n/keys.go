...
const (
	...
	MsgUserReferralClaimSuccess      = "user.referral_claim_success"
	MsgUserReferralClaimFailed       = "user.referral_claim_failed"
	MsgUserReferralNothingToClaim    = "user.referral_nothing_to_claim"
