...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/service-status", middleware.CriticalRateLimit(), controller.GetServiceStatus)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/referrals", controller.GetReferralOverview)
				selfRoute.GET("/referrals/consume", controller.GetInviteeConsumeReport)
				selfRoute.POST("/referrals/claim", middleware.CriticalRateLimit(), controller.ClaimReferralCommissions)
				selfRoute.GET("/topup/info", controller.GetTopUpInfo)
				selfRoute.GET("/topup/self", controller.GetUserTopUps)
				selfRoute.GET("/orders", controller.GetUserOrders)
				selfRoute.GET("/invoices", controller.GetUserInvoiceRequests)
				selfRoute.POST("/invoices", middleware.CriticalRateLimit(), controller.CreateInvoiceRequest)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/invoices/admin", controller.AdminGetInvoiceRequests)
				adminRoute.POST("/invoices/admin/:id/review", middleware.CriticalRateLimit(), controller.AdminReviewInvoiceRequest)
				adminRoute.POST("/invoices/admin/:id/issue", middleware.CriticalRateLimit(), controller.AdminSetInvoiceURL)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/client-ip-blacklist", controller.GetClientIPBlacklistSetting)
			optionRoute.PUT("/client-ip-blacklist", controller.UpdateClientIPBlacklistSetting)
		...
		apiRouter.GET("/token/user", middleware.CORS(), middleware.CriticalRateLimit(), middleware.TokenAuthReadOnly(), controller.GetTokenUser)
